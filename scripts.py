...
def capture_can_data():
    ...
    # Capturer les données CAN via candump et les enregistrer dans candump.log
    print("Capture des données CAN avec candump...")
    os.system("candump -c -l vcan0 > candump.log")

    # Rejouer les données CAN capturées
    print("Relecture des données CAN avec canplayer...")
    os.system("canplayer -I candump.log")
